...
function SkillList() {
  return (
    <main
      id="skills"
      className="bg-rose-50 px-6 md:px-10 py-16 md:py-20"
    >
      <div className="max-w-7xl mx-auto">

        {/* Título  */}
        <div className="mb-10">
          <p className="text-sm font-semibold text-pink-400 uppercase tracking-widest mb-2">
            Mis conocimientos
          </p>
          ...
          <p className="text-rose-700/70 mt-3 max-w-2xl">
